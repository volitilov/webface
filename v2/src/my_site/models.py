...
class Mesage(models.Model):
	...
	name = models.CharField(max_length=30, verbose_name='Имя:', default='имя')
	email = models.EmailField(verbose_name='Почт. ящик:', default='email')
	text = models.TextField(verbose_name='Сообщение:', default='сообщение')
